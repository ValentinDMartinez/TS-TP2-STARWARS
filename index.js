...
function drawTable(people) {
    // Prepare table HTML
    var tableHTML = "\n  <thead>\n    <tr>\n      <th><button type=\"button\" class=\"btn btn-link\" onclick=sortPeople(\"name\")>Nombre</button></th>\n      <th><button type=\"button\" class=\"btn btn-link\" onclick=sortPeople(\"birth_year\")>A\u00F1o nacimiento</button></th>\n      <th><button type=\"button\" class=\"btn btn-link\" onclick=sortPeople(\"gender\")>Genero</button></th>\n      <th><button type=\"button\" class=\"btn btn-link\" onclick=sortPeople(\"url\")>URL</button></th>\n    </tr>\n  </thead>\n  <tbody>\n  ";
